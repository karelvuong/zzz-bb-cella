        ...
        Container { // BODY - START
            ...
            Container {
                ...
                Container { // HOUSE - START
                    ...
                    gestureHandlers: [ TapHandler { onTapped: { _app.readRecordsLocation(); activeTab = tabHouse }}]
                    
                    ImageView { 
                        imageSource: "asset:///images/icons/dashboard/icon-house.png"
                        horizontalAlignment: HorizontalAlignment.Center
                    }
                    ...
                    Label { // CITY, PROVINCE/STATE, COUNTRY - START
