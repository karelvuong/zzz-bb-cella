        ...
        titleBar: TitleBar {
            ...
            acceptAction: ActionItem {
                ...
                onTriggered: {
                    ...
                    if (p == 'asset:///images/placeholders/house/house-placeholder-add.png')
                         p = 'asset:///images/placeholders/house/house-placeholder.png'
                    
                    // SAVE VALUES
                    _app.saveValueFor('house-street_num', tfStreetNumber.text.trim())
                    _app.saveValueFor('house-street_name', tfStreetName.text.trim())
                    _app.saveValueFor('house-street_suffix', ddStreetSuffix.selectedOption.text)
                    _app.saveValueFor('house-unit', tfUnit.text.trim())
                    _app.saveValueFor('house-municipality', tfMunicipality.text.trim())
                    _app.saveValueFor('house-province', tfProvince.text.trim())
                    _app.saveValueFor('house-postal_code', tfPostal.text.trim())
                    _app.saveValueFor('house-sqft', tfSqFt.text.trim())
                    _app.saveValueFor('house-stories', s)
                    _app.saveValueFor('house-year_built', tfYearBuilt.text.trim())
                    _app.saveValueFor('house-year_purchased', tfYearPurchased.text.trim())
                    _app.saveValueFor('house-picture', p)
                    
                    // UPDATE LABELS IN HOUSE TAB
                    street_num = _app.getValueFor('house-street_num', '')
                    street_name = _app.getValueFor('house-street_name', '')
                    street_suffix = _app.getValueFor('house-street_suffix', '')
                    unit = _app.getValueFor('house-unit', '')
                    municipality = _app.getValueFor('house-municipality', '')
                    province = _app.getValueFor('house-province', '')
                    postal_code = _app.getValueFor('house-postal_code', '')
                    sqft = _app.getValueFor('house-sqft', '')
                    stories = _app.getValueFor('house-stories', '')
                    year_built = _app.getValueFor('house-year_built', '')
                    year_purchased = _app.getValueFor('house-year_purchased', '')
                    picture = _app.getValueFor('house-picture', 'asset:///images/placeholders/house/house-placeholder.png')
        ...
        ScrollView { // SCROLLVIEW - START
            Container {
                Container { // PICTURE - START
                    ...
                    ImageView {
                        id: ivPicture
                        imageSource: (picture == 'asset:///images/placeholders/house/house-placeholder.png' ? 'asset:///images/placeholders/house/house-placeholder-add.png' : picture)
                    ...
                    ImageButton {
                        ...
                        visible: (ivPicture.imageSource != 'asset:///images/placeholders/house/house-placeholder-add.png')
                        onClicked: { ivPicture.imageSource = 'asset:///images/placeholders/house/house-placeholder-add.png' }
                    }
                }  // PICTURE - END
                ...
                Container { // WRAPPER - START
                    ...
                    Container {
                        ...
                        TextField {
                            id: tfStreetNumber
                            hintText: "Number"
                            text: _app.getValueFor('house-street_num', '')
                        ...
                        TextField {
                            ...
                            text: _app.getValueFor('house-street_name', '')
                            layoutProperties: StackLayoutProperties { spaceQuota: 3 }
                            verticalAlignment: VerticalAlignment.Center
                        ...
                        DropDown {
                            ...
                            onCreationCompleted: {
                                var s = _app.getValueFor('house-street_suffix', '')
                    ...
                    Container {
                        ...
                        TextField {
                            ...
                            text: _app.getValueFor('house-unit', '')
                        ...
                        TextField {
                            ...
                            text: _app.getValueFor('house-municipality', '')
                            input.submitKey: SubmitKey.Next
                        }
                        
                        TextField {
                            id: tfProvince
                            hintText: "Province/State (e.g. Ontario)"
                            text: _app.getValueFor('house-province', '')
                            input.submitKey: SubmitKey.Next
                            onTextChanging: {
                        ...
                        TextField {
                            ...
                            text: _app.getValueFor('house-postal_code', '')
                            input.submitKey: SubmitKey.Next
                        }
                    }  // LOCATION - END
                    ...
                    Container {
                        ...
                        TextField {
                            id: tfSqFt
                            hintText: "Sq. Ft"
                            text: _app.getValueFor('house-sqft', '')
                            inputMode: TextFieldInputMode.Pin
                            input.submitKey: SubmitKey.Next
                            onTextChanging: {
                                var t = tfSqFt.text
                        ...
                        DropDown {
                            ...
                            onCreationCompleted: {
                                var s = _app.getValueFor('house-stories', '')
                                var dd = ddStories
                                if(s.length > 0) {
                                    dd.visible = true
                    ...
                    Container {
                        ...
                        TextField {
                            id: tfYearBuilt
                            hintText: "Year Built"
                            text: _app.getValueFor('house-year_built', '')
                            inputMode: TextFieldInputMode.Pin
                            input.submitKey: SubmitKey.Next
                            onTextChanging: {
                        ...
                        TextField {
                            ...
                            text: _app.getValueFor('house-year_purchased', '')
                            inputMode: TextFieldInputMode.Pin
                            input.submitKey: SubmitKey.Next
                            onTextChanging: {
